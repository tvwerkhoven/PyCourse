...
\includegraphics[height=10mm]{\imgpath logo_uu.pdf}\\[1cm]
\includegraphics[width=0.7cm]{\imgpath cc.pdf}~%
\includegraphics[width=0.7cm]{\imgpath by.pdf}~%
\includegraphics[width=0.7cm]{\imgpath sa.pdf}~%
}
\date{}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]{Objects II}
