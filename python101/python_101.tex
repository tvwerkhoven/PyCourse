...
%%
%% Tim van Werkhoven (t.i.m.vanwerkhoven@gmail.com), 20110321
%%
...
%\usepackage{color} % color is old, don't use
\usepackage{xcolor}
...
\begin{frame}[fragile]{Boxes vs. names}
	...
	\begin{center}
	\only<1>{\includegraphics[width=2cm]{\imgpath a1box.png}}
	\only<2->{\includegraphics[width=2cm]{\imgpath a2box.png}}
	\uncover<3->{\includegraphics[width=2cm]{\imgpath b2box.png}}
	\end{center}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}[fragile]{Boxes vs. names}
	...
	\begin{center}
	\only<1>{\includegraphics[height=2cm]{\imgpath a1tag.png}}
	\only<2->{\includegraphics[height=1.4cm]{\imgpath 1.png}}
	\only<2>{\includegraphics[height=2cm]{\imgpath a2tag.png}}
	\only<3->{\includegraphics[height=2cm]{\imgpath ab2tag.png}}
	\end{center}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%			Variable & Value \\
%			\hline
%			\verb!alist! \tikz[na] \node[coordinate] (w1) {}; & \tikz[na] \node[coordinate] (w1v) {};\verb![1, 2, 3, 4]! \\
%			\verb!blist! \tikz[na] \node[coordinate] (w2) {}; & \tikz[na] \node[coordinate] (w2v) {};\verb![5, 2, 3, 4]! \\
%			\end{tabular}
%		\end{column}
%	\end{columns}
%	
%	\begin{tikzpicture}[overlay]
%		\path[->]<5-6> (w1) edge [bend left] (w1v);
%		\path[->]<6> (w2) edge [bend right] (w1v);
%		\path[->]<7-> (w1) edge [bend left] (w2v);
%		\path[->]<7-> (w2) edge [bend right] (w2v);
%	\end{tikzpicture}
%
%\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}[fragile]
	...
	If the variable is mutable, it acts like \emph{pass by reference}:
	\spacer
...
\begin{frame}[fragile]{Functional programming -- filter}
	...
	\begin{python}
	>>> def div_by_three(x): return (x % 3 == 0)
	...
